import { Img, ImgUrl, Item, allProducts } from "./types";

export const base_url = 'https://63e7a708ac3920ad5be16a86.mockapi.io/api/v1'

export const calcTotalPrice = (items: any[]) => items.reduce((acc: any,shoes: { price: any; }) => acc += shoes.price, 0)
...
export const AllProducts:Array<allProducts> = [
  ...
  {
    mainImg: "mainImg_2",
    description: "Say I do (again) to the shoes you want to wear for the rest of your life. Returning to the original materials and keeping everything you love best—classic leather construction and the perfect amount of hoops style—the Nike Air Force 1 Low Retro celebrates the icon of everyday fashion. Now with a sneaker cleaning brush to keep your look crisp",
  ...
  {
    mainImg: "mainImg_17",
    description: "Elena Delle Donne's debut basketball shoe invites everyone to step in and take a shot at the game. Made for all athletes of all abilities, it has a collapsible heel and a large strap, so you can get in and lock in with one hand. Full-length Nike Air cushioning plus a forefoot Zoom Air unit give you an optimal blend of bounce and energy return to help you feel fresh all game long. ",
  ...
  {
    mainImg: "mainImg_23",
    description: "How fly is too fly? Your child might get close in these kicks inspired by decades of Jordan design. Mesh and leather uppers give plenty of stability without the worry of weighing 'em down. Plus, hook-and-loop closures keep their sneaks snug (and makes put-on and take-off easy).",
  ...
  {
    mainImg: "mainImg_22",
    description: "These kicks are designed for up-and-coming sneakerheads with big ideas. A bold mix of colours and materials makes a splash, while the see-through Max Air unit embraces futuristic design. Use the handy pull tabs to get your shoes on without missing a beat and zip through your day in comfort.",
  ...
  {
    mainImg: "mainImg_25",
    description: "What's Omni, you ask? It means universal, inclusive and all. Playtime is about freedom and imagination. As the ultimate play shoe, there are no limits when your kid pulls these Nikes on. They're durable for any indoor court surface and lightweight to help make play comfortable.",
  ...
  {
    mainImg:"mainImg_26",
    description: "Gear up in Jordan heritage. With details drawn from decades of shoes, the Stay Loyal 2 is a collage of cool. Mesh and leather upper gives you stability without the worry of weighing you down. Air in the heel keeps you cushioned. Get out and play!",
  ...
  {
    mainImg: "mainImg_27",
    description: "Let your child rep the legendary career of 'His Airness' with the Jordan 6 Rings. Incorporating key features of each shoe worn during MJ's championship series, it has details that pop and comfy cushioning for growing feet.",
    name: "Jordan 6 Rings",
    price: 319.90,
    firsImg: "firsImg_27",
  ...
  {
    mainImg: "mainImg_28",
    description: "Even MJ was a kid once! Inspired by Mike's backyard battles with his older brother Larry, the Jordan Series references their legendary sibling rivalry throughout the design. Look for the hidden reminder to 'Swing for the Fence', a direct quote from Larry to his little bro.",
  ...
  {
    mainImg: "mainImg_29",
    description: "Simple, comfortable and cushioned with Air—the Nike Air Max SC is an easy yes. The mixture of textures creates a durable and lightweight design you can rock all day, any day.",
